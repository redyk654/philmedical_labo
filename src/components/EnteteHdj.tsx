...
import { styleEntete } from '../services/function.tsx';
import logo from '../assets/images/logo_hdj.png';

export default function EnteteHopital() {
  return (
    <div style={{textTransform: 'uppercase', padding: '', marginBottom: '2px', width: '100%', display: 'flex', justifyContent: 'space-between'}}>
